...
Nine main reasons why you should use Sprinto:

1. __Brings writers together__. Get A+ scores on [Mozilla Observatory](https://observatory.mozilla.org/analyze/doks.netlify.app) out of the box. Easily change the default Security Headers to suit your needs.

2. __Easy to use__. Get 100 scores on [Google Lighthouse](https://googlechrome.github.io/lighthouse/viewer/?gist=59aafe464a68f8bc30b8e9a636d5b053) by default. Doks removes unused css, prefetches links, and lazy loads images.

3. __Flexible__. Use sensible defaults for structured data, open graph, and Twitter cards. Or easily change the SEO settings to your liking.
